...
const ManageBookings = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 w-full'>
      <Title title="Manage Bookings" subTitle="Track all customer bookings, approve or cancel requests, and manage bookings statues." />
        ...
        <table className='w-full border-collapse text-left text-sm text-gray-600'>
          ...
          <tbody>
            {bookings.map((booking, index)=>(
              <tr key={index} className='norder-t border-borderColor text-gray-500'>
                ...
                <td className='p-3 max-md:hidden'>
                  {booking.rentalStartDate.split('T')[0]} to {booking.rentalEndDate.split('T')[0]}
                </td>

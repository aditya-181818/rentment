...
const Dashboard = () => {
  ...
  const[data,setData] = useState({
   ...
   monthlyRevenue: 0,
     ...
     const dashboardCards = [
      {title: "Total Products", value: data.totalProducts, icon: assets.productIconColored },
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
      <Title title="User Dashboard" subTitle="Monitor overall platform performance including total products, booking, revenue, and recent activites"/>
